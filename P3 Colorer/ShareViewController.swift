...
class ShareViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        returnButton.setBackgroundImage(UIImage(named: "returnIcon"), forState: .Normal)
        ...
        facebookButton.setBackgroundImage(UIImage(named: "facebookIcon"), forState: .Normal)
        ...
        twitterButton.setBackgroundImage(UIImage(named: "twitterIcon"), forState: .Normal)
